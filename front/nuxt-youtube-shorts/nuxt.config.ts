...
export default defineNuxtConfig({
	...
	imports: {
		dirs: ['constants', 'types', 'utils', 'composables']
	},

	modules: ['@nuxt/fonts', '@nuxt/eslint', '@nuxt/icon', '@nuxt/image', '@nuxt/scripts', '@primevue/nuxt-module', '@nuxtjs/tailwindcss', '@pinia/nuxt'],
	pinia: {
		storesDirs: ['./stores/**']
	},
		...
		head: {
			...
			meta: [
				...
				{ name: 'viewport', content: 'width=device-width, initial-scale=1' },
				{
					key: 'description',
					name: 'description',
					content: 'AI로 자동 생성하는 YouTube Shorts - 상품 소개, 스토리 비디오를 몇 번의 클릭으로 전문가 수준으로 제작하세요'
				},
